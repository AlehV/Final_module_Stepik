...
class LoginPage(BasePage):
    ...
    def should_be_login_form(self):
        ...
        assert True
       #   в shold_be_login_form ищем через id login_form в locators


    def should_be_register_form(self):
        assert  self.is_element_present(By.CSS_SELECTOR, "#register_form") == True, "Register form is not presented"
